...
const GRADE_REGEXP_LIST = [
  new RegExp("[" + GRADE1_KANJI + "]", "g"),
  new RegExp("[" + GRADE2_KANJI + "]", "g"),
  new RegExp("[" + GRADE3_KANJI + "]", "g"),
  new RegExp("[" + GRADE4_KANJI + "]", "g"),
  new RegExp("[" + GRADE5_KANJI + "]", "g"),
  new RegExp("[" + GRADE6_KANJI + "]", "g"),
];

export function containsUnlearnedKanji(text: string, grade: number) {
